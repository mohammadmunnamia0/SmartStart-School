  ...
  <section className="py-12 md:py-16 px-4 sm:px-6 md:px-8">
    <div className="max-w-6xl mx-auto">
      ...
      <div className="max-w-5xl mx-auto border-2 border-gray-200 rounded-3xl shadow-xl p-6 sm:p-8 md:p-12 lg:p-20 text-center bg-white">
        <div className="flex justify-center text-4xl sm:text-5xl md:text-6xl text-cyan-400 mb-6">
          <FaSchool />
        </div>
        <div>
          ...
          <ServicesButton to="/courses" label="Learn More" />
        </div>
      </div>
    </div>
  </section>
