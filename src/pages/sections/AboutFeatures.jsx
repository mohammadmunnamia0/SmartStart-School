  ...
  <section className=" px-4 bg-gray-50">
    <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-2 items-center">
      <img
        src={placeholder2}
        alt="Happy child"
        className=" object-cover h-2/3 rounded-t-full rounded-b-full shadow-xl mx-auto transition-transform duration-300 ease-in-out hover:-translate-y-1"
      />
      <div>
    ...
    <div className="max-w-5xl ml-28 grid md:grid-cols-2 gap-12 items-center mb-16 ">
      <div>
        <h2 className="text-3xl font-extrabold mb-4">
          Children Come to Know <br /> and Be Known
        </h2>
